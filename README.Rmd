...
The results show that there is a significant difference of temperatures between crab types. We know this because the F value is not close to 1 and the P value is smaller than 0.05. 
